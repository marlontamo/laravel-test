...
import axios from 'axios';
    export default {
        ...
        created(){
          axios.get('https://robinsonslandcorporation.site/laravel-test/public/api/users')
        ...
        methods:{
            edit : function(id){
                axios.get('https://robinsonslandcorporation.site/laravel-test/public/api/user/'+id)
            ...
            del: function(id){
                ...
                if(user){
                    ...
                    axios.delete('https://robinsonslandcorporation.site/laravel-test/public/api/user/'+id)
                .then((res)=> 
